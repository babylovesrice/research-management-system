        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>Departmental Research</span>
              </a>
              <ul class="sub">
              <li><a href="userlog.php">DTP Research</a></li>
              <li><a href="#">DAS Research</a></li>
              <li><a href="#">DTE Research</a></li>
              <li><a href="#">DCJE Research</a></li>
              <li><a href="#">DBA Research</a></li>
              <li><a href="#">DAE Research</a></li>
