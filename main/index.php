 ...
 <?php
            ...
            if(isset($_POST['post'])){
             ...
             $tp=date('H:i:sa');
                 ...
                 $quer =$link->query("INSERT INTO tbl_anno values('Null','$from', '$to', '$what', '$dp', '$tp')");
                      if($quer){
                          echo "<html>
                        <head>
      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <!-- **********************************************************************************************************************************************************
            ...
            <div class="col-lg-3 ds profile-text">
            ...
            <div class="row">
                 ...
                 <center><br>
                  <h4>8,000</h4>
                  <h6>PUBLISH RESEARCH</h6>
                  <h4>1,000</h4>
                  <h6>PROPOSED TITLE</h6>
                  <h4>575</h4>
                  <h6>APPROVED TITLE</h6>
                  <h4>82</h4>
                  <h6>ON-GOING RESEARCH</h6>
