...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>R <span>M S</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="teachlog.php">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
              ...
              <?php
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <p>
                        <name><?php echo $data['anno_from']; ?></name> 
                         <?php echo $data['Date']; ?>
                      </p>
                      
                      <p class="small"><?php echo $data['time']; ?></p><br>
                      <p class="message"><b>What:  </b><?php echo $data['anno_what']; ?><br><b>When:  </b><?php echo $data['anno_when']; ?><br><b>Where: </b><?php echo $data['anno_where']; ?></p>
